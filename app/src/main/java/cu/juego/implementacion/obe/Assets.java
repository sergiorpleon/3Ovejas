...
//public static Pixmap bagon3;
    ...
    public static Pixmap cerca;
    public static Pixmap establo;
    public static Pixmap perro;
    public static Pixmap obeja;
    public static Pixmap libre;
    public static Pixmap arbol;
...
//public static Sonido derrota;
    ...
    public static Sonido felicidades;
    public static Sonido clic;
    public static Sonido clic1;
    public static Sonido bee;
