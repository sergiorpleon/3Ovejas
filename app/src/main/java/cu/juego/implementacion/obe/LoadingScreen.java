...
public class LoadingScreen extends Pantalla {
    ...
    public void update(float deltaTime) {
        ...
        Assets.establo = g.newPixmap("establo.png", PixmapFormat.ARGB4444);
        Assets.perro = g.newPixmap("perro.png", PixmapFormat.ARGB4444);
        Assets.obeja = g.newPixmap("obeja.png", PixmapFormat.ARGB4444);
